...
const resources = {
  en: {
    translation: {
      ...
      a1: "Wulfaria functions as a smart, functional B2B directory connecting quality suppliers, logistics providers, and manufacturers with buyers globally.",
      q2: "Who are the suppliers?",
      ...
      q5: "Do you sell products already?",
  ...
  nl: {
    translation: {
      ...
      a1: "Wulfaria functioneert als een slimme, functionele B2B-gids die kwalitatieve leveranciers, logistieke dienstverleners en fabrikanten wereldwijd met kopers verbindt.",
      q2: "Wie zijn de leveranciers?",
  ...
  ar: {
    translation: {
      ...
      q1: "ماذا تفعل الشركة؟",
      a1: "تعمل وولفارا كدليل B2B ذكي وعملي يربط الموردين الجيدين ومزودي الخدمات اللوجستية والمصنعين بالمشترين على مستوى العالم.",
      q2: "من هم الموردون؟",
