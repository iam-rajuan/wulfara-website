...
export default function HelpCenterArticles() {
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-[1280px] mx-auto bg-[#fafafa]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {articles.map((article, index) => (
          <a
            key={index}
            href="#"
            className="flex items-center justify-between p-4 bg-white rounded border border-slate-100 hover:border-[#dca12f]/30 hover:shadow-sm transition-all group"
          >
            ...
            <ArrowRight className="h-4 w-4 text-slate-200 group-hover:text-[#dca12f] transition-colors" />
          </a>
        ))}
      </div>
    </div>
